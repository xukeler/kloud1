...
const router = new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      children:[
        { name: 'klassroom-schedule', path: 'schedule', component: ScheduleView},
        { name: 'klassroom-activity', path: 'activity', component: ActivityView},
        { name: 'klassroom-courses', path: 'courses', component: KlassroomCourses},
        { name: 'klassroom-homework', path: 'homework', component: KlassroomHomework },
        { name: 'klassroom-students', path: 'students', component: KlassroomStudents},
        { name: 'klassroom-teachers', path: 'teachers', component: KlassroomTeachers},
        { name: 'klassroom-customers', path: 'customers', component: KlassroomCustomers},
        { name: 'klassroom-setting', path: 'setting', component: KlassroomSetting},
        { name: 'klassroom-profile', path: 'profile', component: KlassroomProfile},
        { name: 'klassroom-create-course', path: 'courses/create', component: KlassroomCreateCourse},
        { name: 'klassroom-create-lesson', path: 'lesson/create', component: KlassroomCreateLesson},
        { name: 'klassroom-course-item', path: 'courses/:courseId', component: KlassroomCourseItem},
        { name: 'klassroom-school-profile', path: 'school/profile', component: KlassroomSchoolProfile},
        { name: 'klassroom-school-setting', path: 'school/setting', component: KlassroomSchoolSettings},
      ]
    },
    {
      name: 'kloudsync',
    ...
    { name: 'liveex', path: '/live/:id', component: LiveLesson},
    { name: 'live', path: '/live', component: LiveLesson,meta: { needlogin: true } },
    ...
    { name: 'record', path: '/record/:shareid', component: LessonView },
    ...
    { name: 'meeting', path:'/meeting', component: Meeting,meta:{needlogin:true}},
    { path: '*', redirect: '/' }
  ]
})
