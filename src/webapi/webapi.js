...
export default {
    ...
    */
    ...
    async GetSpaceAttachmentList(spaceID,pageIndex,pageSize)
    {
        var url = GetAPIUrl() + "SpaceAttachment/List?spaceID=" + spaceID + "&type=0&searchText=&pageIndex=" + pageIndex + "&pageSize=" + pageSize;
        var result = await　this.getAjax(url);
        if (!result || result.RetData=="")
        {
            return null;
