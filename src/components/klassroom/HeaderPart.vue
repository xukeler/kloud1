  ...
  <div class="header-part">
    <div class="primary-header">
      ...
      <div class="main-router">
        ...
        <div class="clickable" :class="{'current': currentView === 'customers'}" v-show="isEnterprise" @click="goCustomers" title="customers">
          {{$t("BusinessHeader.Customers")}}
          <div class="bottom-line"></div>
        </div>
...
export default {
  ...
  computed: {
    ...
    showSecondary() {
      ...
      return !this.isEnterprise && (name == "klassroom-courses" || name == "klassroom-students") && (this.KlassroomSettings.termCount > 0 || this.KlassroomSettings.cohortCount > 0);
    },
    isEnterprise() {
      return this.Klassroom.type == 1 || auth.getSchoolType() > 1;
    },
    studentsLabel() {
      return this.isEnterprise ? this.$t("BusinessHeader.Employees"): this.$t("Base.Students");
    },
    teachersLabel() {
      return this.isEnterprise ? this.$t("BusinessHeader.Trainers") : this.$t("Base.Teachers");
    },
    currentCohort() {
