...
export default {
  ...
  methods: {
    loadCatalog() {
      ...
      url += "&termYear=" + (this.showGrade ? this.currentTermYear : -1);
    ...
    _typeName(type) {
      if (this.isEnterprise) {
        switch (type) {
          case 0: // School
            return this.$t('CatalogPart.Company');
          case 1: // Campus
            return this.$t('CatalogPart.Branch');
          case 2: // College
            return this.$t('CatalogPart.CompanyDepartment');
          case 3: // Department
            return this.$t('CatalogPart.Division');
          case 4: // Specialty
            return this.$t('CatalogPart.Section');
          // case 5: // Grade
          //   return this.$t('CatalogPart.Group');
          default:
