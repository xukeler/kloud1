    ...
    <div class="catalog-node-action">
      <Dropdown placement="bottom-end" @on-click="actionOnClick">
        ...
        <DropdownMenu slot="list">
          <DropdownItem v-if="data.type > 0 && data.type < 10" name="add-sibling"><Icon size="16" type="arrow-return-left"></Icon>{{$t('CatalogPart.AddSibling')}}</DropdownItem>
          <DropdownItem v-if="data.type < 10" name="add-child"><Icon size="16" type="plus-round"></Icon>{{$t('CatalogPart.AddChild')}}</DropdownItem>
