  ...
  <div class="klassroom-create-lesson">
    ...
    <div class="content">
        ...
        <div class="course-create-box">
          <table class="course-content">
            ...
            <tr v-show="createCourse.template > 0">
              ...
              <td>
                <Input :value="createCourse.authorLessonCount" disabled placeholder="" style="width: 100%;"/>
              </td>
              <td>
              </td>
            </tr>
            <tr v-show="createCourse.template > 0">
              ...
              <td>
                <Input :value="createCourse.authorLessonCost" disabled placeholder="" style="width: 100%"/>
              </td>
              <td>
              </td>
            </tr>
            <tr v-show="createCourse.template > 0">
              ...
              <td>
                <Input :value="createCourse.authorCost" placeholder="$" disabled style="width: 100%;"/>
              </td>
              <td>
              </td>
            </tr>
            ...
            <tr v-show="createCourse.template > 0">
              ...
              <td>
                <Input v-model="createCourse.lessonCount" placeholder="" style="width: 100%"/>
              </td>
              <td>
              </td>
            </tr>
            <tr v-show="createCourse.template > 0">
              ...
              <td>
                <Input v-model="createCourse.lessonCost" placeholder="" style="width: 100%"/>
              </td>
              <td>
              </td>
            </tr>
            <tr v-show="createCourse.template > 0">
              ...
              <td>
                <Input :value="createCourse.costTotal" placeholder="$" disabled style="width: 100%;"/>
              </td>
              <td>
              </td>
            </tr>
        ...
        <div v-show="lessonCourseInfo.groupEnable || lessonType === 1">
          <table class="lesson-content">
            <tr>
              ...
              <td>
                <Input v-model="lessonCourseInfo.studentCount" disabled placeholder="" style="width: 100%"/>
              </td>
              <td>
              </td>
            </tr>
            <tr v-show="lessonType === 0">
              ...
              <td>
                <Input v-model="lessonCourseInfo.studentCost" disabled placeholder="" style="width: 100%"/>
              </td>
              <td>
              </td>
            </tr>
        ...
        <div v-show="lessonCourseInfo.audienceEnable || lessonType === 1">
          <table class="lesson-content">
            <tr>
              ...
              <td>
                <Input v-model="lessonCourseInfo.audienceCost" disabled placeholder="" style="width: 100%"/>
              </td>
              <td>
              </td>
            </tr>
      ...
      <div class="lesson-lesson" v-show="lessonCourse > 0">
        ...
        <lesson-list ref="lessonList" :course-id="lessonCourse" :lesson-type="lessonType" :create-lesson="true"></lesson-list>
      </div>
    </div>
    <div class="footer">
...
<script>
  ...
  import CourseStudents from '../courses/CourseStudents.vue';
  import CourseAudience from '../courses/CourseAudience.vue';
