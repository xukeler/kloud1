                ...
                <table>
                  <tr>
                    ...
                    <td>
                      ...
                      <p>Allow manage courses, employees, customers and trainers across branch when enable</p>
                    </td>
                    <td></td>
                    <td>
                      <i-switch v-model="enableCampus" size="large">
                  ...
                  <tr>
                    <td><i class="icon icon-organization color-brown"></i></td>
                    <td>
                      <h3>Allow customers to share company's sale collateral</h3>
                      <p>Allow customers to share company's sale collateral with social media</p>
                    </td>
                    <td></td>
                    <td>
                      <i-switch v-model="enableShare" size="large">
                        <span slot="open">ON</span>
                        <span slot="close">OFF</span>
                      </i-switch>
                    </td>
