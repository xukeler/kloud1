<template>
  <div class="kloudsync-topic-meetings" :style="{'height':inSyncRoomMeeting?'500px':'calc(100vh - 275px)','width':inSyncRoomMeeting?'400px':'100%'}">
    ...
    <Modal v-model="modalScheduleMeeting" :mask-closable="false" :width="640" title="Schedule a meeting">
      <div class="kloudsync-schedule-topic-meeting">
...
.kloudsync-schedule-topic-meeting {
