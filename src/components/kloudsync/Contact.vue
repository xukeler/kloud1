...
export default {
  ...
  methods: {
    ...
    sendMessege(){
      this.$router.push({ name: "kloudsync-chat",params:{contactPerson:{rongCloudUserID:this.selectPerson.senToRongCloudUserID,userId:this.selectPerson.ptuserId,name:this.selectPerson.detailContactName,type:'contact'}}});
    },
