<template>
  <div class='kloudsync-topic-members'>
    ...
    <div>
      ...
      <Modal v-model="modalChangeCompany" :mask-closable="false" :title="$t('TopicHomePage.AddCustomer')" style="z-index: 99; position: absolute;">
        <div class="kloudsync-change-company-modal">
          <p style="margin-bottom:0.5em;">
      ...
      <Modal v-model="modalCompanyInfo" :title="$t('TopicHomePage.CompanyInfo')">
        <div class="kloadsync-topic-contact-company">
...
.kloadsync-topic-contact-company {
  .company-name {
    color: #1c2438;
    font-size: 16px;
    font-weight: bold;
...
.kloudsync-change-company-modal{
  span{
