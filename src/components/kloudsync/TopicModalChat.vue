<template>
<div class="sync-room-modal-chat">
  ...
  <div class="footer-part" @click.stop="getFocus">
      ...
      <div ref="kloudsyncEmolist" v-show="showemojiList" style="white-space: normal;position:absolute;bottom:122px; left:5px;width:260px;background-color:#ccc;padding:5px 2px;border: 0.5px solid #888888;text-align: left;">
