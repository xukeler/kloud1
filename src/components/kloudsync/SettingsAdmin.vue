  ...
  <div class="kloudsync-settings-admin">
    <div class="panel-header">
      ...
      <div class="panel-header-right">
        ...
        <Button type="success" icon="plus-round" @click="handleAddAdmin">Add admin user</Button>
      </div>
    </div>
    ...
    <div>
      <Modal v-model="modalAddAdmin" :mask-closable="false" title="Add Admin" :width="800">
        <Table :columns="contactColumns" :data="contactData" :loading="loading"  @on-selection-change="contactSelectionChanged" no-data-text="No Contact Invited." stripe highlight-row></Table>
