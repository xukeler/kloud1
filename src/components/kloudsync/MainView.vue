...
export default {
  ...
  methods: {
    ...
    reloadKloudSyncMainview(){
      this.isKloudSync=false;
      this.$nextTick(function(){
        this.isKloudSync=true;
      })
    },
    reloadHeader() {
