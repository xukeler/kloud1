<template>
  <Poptip ref="filterPoptip" style="position:absolute; top: 6px; left: 574px;">
    ...
    <div class="schedule-filter-content" slot="content">
      <Tabs v-if="isEnterprise" value="teachers" :animated="false">
        <TabPane label="Trainers" name="teachers">
        ...
        <TabPane label="Employees" name="students">
          <Input style="margin: 0.5em 0;" v-model="searchText" icon="search" placeholder="Search"/>
        ...
        <TabPane label="Customers" name="customers">
          <Input style="margin: 0.5em 0;" v-model="searchText" icon="search" placeholder="Search"/>
          <div class="user-item" v-for="item in allCustomers" :key="item.id">
            <Avatar :src="item.avatar" />
            <span class="user-name">{{item.name}}</span>
          </div>
        </TabPane>
      ...
      <Tabs v-else value="teachers" :animated="false">
