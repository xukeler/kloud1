  ...
  methods: {    
    init(){
      ...
      $("#scheduleViewActions").kendoContextMenu({
        ...
        select: function(e) {
          ...
          if (selection.events.length > 0) {
            ...
            switch (e.item.id) {
              case "scheduleViewEventView":
                self.scheduler.editEvent(event);
                break;

              case "scheduleViewEventEdit":
                self.editLesson(event.id);
                break;
      ...
      $("#scheduleView").kendoScheduler({
        ...
        workDayStart: new Date(2017, 1, 1, 8, 0, 0),
        workDayEnd: new Date(2017, 1, 1, 20, 0, 0),
        dateHeaderTemplate:
        ...
        edit: function(e) {
          e.preventDefault();
          self.editEvent(e.event.id);
        },
        remove: function(e) {
          self.removeEvent(e.event.id);
        },
        moveStart: function(e) {},
        move: function(e) {},
        moveEnd: function(e) {
          self.timeChanged(e.event.id, e.start, e.end);
        },
        ...
        schema: {
          model: {
            ...
            fields: {
              ...
              recurringId: { from: "MasterLessonID", defaultValue: 0},
