...
<script>
  ...
  export default {
    ...
    mounted: function () {
      ...
      {
        this.$router.push({ name: 'live', query: { id: + this.meetingId } });
        //location.href = "/live?id=" + this.meetingId;
      }
      else
      {
    ...
    methods: {
      ...
      join() {
        ...
        //this.loading = true;
        //auth.login(this, credentials, {name: 'live', query: {id: '-' + this.meetingId}}, result => {
        //  this.loading = false;
        //  if (result) {
        //    this.$parent.$refs.noticemsg.init();
        //  }
