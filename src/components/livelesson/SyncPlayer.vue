    ...
    methods: {
        ...
        stopSyncAudio(evt,power=false,playend=false) {
            ...
            if (this.playSyncInfo.Play == true) {
                ...
                //this.syncRecorder.stop();//syncplayersyncaudio
                //this.syncRecorder.play(gid('syncplayersyncaudio'));
                //this.syncRecorder.getData(base64 =>
                //{
                //  console.log(base64);
                //});

                if(websocket) websocket.audiosync(0, this.lastSycnAudioItemID,new Date()-this.syncTimeAxis.StartTime);
        ...
        uploadSyncRecordAudio(data,duration) {
            ...
            xhr.onload = event => {
                ...
                {
                    this.$Message.error('Upload Sync Error!');
                }
            };
