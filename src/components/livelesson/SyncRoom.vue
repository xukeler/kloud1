<template>
  <div id="syncroom" class="syncroom">
    <div id="previewHolderOuter" class="previewHolderOuter2">
      ...
      <div id="main" class="maincontainer" v-show="syncRoomType != 2"></div>
    ...
    <div id="livePanelTopCtlWrap" class="livePanelTopCtl-wrap attendee-view attendee-view-open">
          <section id="livePanelTopCtl" style="display: flex;justify-content: center;">
            ...
            <div v-if="syncRoomType != 2 ">
                <Poptip placement="top"  @on-popper-show="disableChatToolTip=true" @on-popper-hide="disableChatToolTip=false">
                    <Tooltip placement="top" transfer :content="$t('KloudSyncHead.Chat')" :disabled="disableChatToolTip">
                        <div class="livePanelTopCtlbtn" style="margin-left:10px;">
            ...
            <Poptip placement="top"  @on-popper-show="disableMeetingToolTip=true" @on-popper-hide="disableMeetingToolTip=false">
                <Tooltip placement="top" transfer :content="$t('KloudSyncHead.Meeting')" :disabled="disableMeetingToolTip">
                    <div class="livePanelTopCtlbtn" style="margin-left:10px;">
            ...
            if(self.syncRoomType == 2){
                self.$nextTick(()=>{
                    if(self.$refs.inTopicChatMeeting){
                        ...
                        $("#previewHolderOuter").css({"width":'calc(100% - 401px)',"background-color":"white"});
                    }
                })
            }else{
                self.$nextTick(()=>{
