<template>
    ...
    >
        ...
        <div style="text-align:right; padding:0px 0px 5px;margin-top:-10px;"><Page :total="total" :page-size="15" size="small" @on-change="onChangePageIndex"></Page></div>
...
export default {
  ...
  methods: {
    ...
    showFilesByPage(type=1,page=-1,callback){
        this.favList = [];
        webapi.getMyFavorite(type, -1,page,15).then(d => {
            if(d)
            {
