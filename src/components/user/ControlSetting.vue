  ...
  <div id="controlsetting" style="text-align:left;">
    <div>
      <Row type="flex" justify="center" align="middle" style="margin:5px 2px;">
        ...
        <div>{{$t("Setting.Camera1")}}:</div>
        </Col>
        <Col span="17">
        <Select v-model="selectCamera" style="width:100%; height:30px;">
      ...
      <Row type="flex" justify="center" align="middle" style="margin:0px;">
        ...
        <Col span="17">
        <div style="width:158px; height:10px; background-color:red; margin:0px 0px 10px 8px;border:1px solid #dddee1; background-color:#d8d8d8;">
      ...
      <Row type="flex" justify="center" align="middle" style="margin:5px 2px;" v-show="showChangeLine">
        <Col span="7" style="height:30px; line-height:30px; vertical-align:middle; text-align: right" justify="center" align="middle">
        <div style="line-height:14px;">{{$t("Setting.ScreenShareRes")}}:</div>
        </Col>
        <Col span="17">
    ...
    methods: {
      ...
      saveUserSetting()
      {
        ...
        this.setUserSettingToServer(set).then((result) =>
        {
          ...
          if (this.$parent && this.$parent.AfterSaveControlSetting)
          {           
            this.$parent.AfterSaveControlSetting(this.selectResolution);
          }
        });
