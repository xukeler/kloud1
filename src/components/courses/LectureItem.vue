<template>
  <div class="lecture-item">
    <table class="lecture-info-table">
      <tr>
        <td colspan="2">
          <Input id="lectureTitle" ref="title" v-model="editingLecture.title" :placeholder="$t('LectureList.PlaceholderAnewlecture')" ></Input>
        </td>
      </tr>
      <tr>
        <td colspan="2">
          <Input id="lectureDesc" v-model="editingLecture.desc" type="textarea" :autosize="true" :placeholder="$t('LectureList.placeholderDescription')"></Input>
        </td>
      </tr>
      <tr>
        <td colspan="2">
      ...
      if (this.lectureId < 0) {
        ...
        this._getData(url, null, (result) => {
          ...
          self.editingLecture = {
            ...
            title: "",
            desc: "",
            detail: {"LectureID": self.lectureId, "CourseID": self.courseId, "Title": "", "Description": "", Attachments: []}
          };
