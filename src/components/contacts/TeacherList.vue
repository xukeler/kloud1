  ...
  <div class="teacher-list">
    ...
    <div style="margin-top:1em;">
      ...
      <div v-show="currentTab === 'teacher'">
        <contact-list-generic list-type="teacher" ref="listTeacher" :school-id="schoolId" :on-contact-selected="showContactDetail" :hide-detail-panel="hideDetailPanel"></contact-list-generic>
      </div>
