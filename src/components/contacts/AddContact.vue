          ...
          <div>
            <table class="contact-detail">
              <tr>
                <td>{{$t('Common.Name')}}: </td>
                <td>
                  <Input v-model="contact.firstName" :placeholder="$t('AddContact.PlaceholderFirstName')" style="width: 32%"></Input>
                  <Input v-model="contact.middleName" :placeholder="$t('AddContact.PlaceholderMiddleName')" style="width: 32%"></Input>
                  <Input v-show="!isLanguageCN" v-model="contact.lastName" :placeholder="$t('AddContact.PlaceholderLastName')" style="width: 32%"></Input>
                </td>
                <td></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><Input v-model="contact.birthday" type="date" :placeholder="$t('AddContact.PlaceholderDateOfBirth')"></Input></td>
                <td></td>
              </tr>
              <tr>
                <td>{{$t('Common.Phone')}}: </td>
                <td><Input v-model="contact.phone" :placeholder="$t('AddContact.PlaceholderPhoneNumber')"></Input></td>
                <td><span style="color:red;padding-left:20px;">{{$t('Common.Required')}}</span></td>
              </tr>
              <tr>
                <td>{{$t('Common.Email')}}: </td>
                <td><Input v-model="contact.email" type="email" :placeholder="$t('AddContact.PlaceholderEmailAddress')"></Input></td>
                <td></td>
              </tr>
            </table>
          </div>
          ...
          <div v-if="isStudent">
            <table class="contact-detail">
              <tr>
                ...
                <td><Input v-model="student.grade" :placeholder="$t('AddContact.PlaceholderGrade')"></Input></td>
                <td></td>
              </tr>
              <tr>
                <td>{{$t('Common.School')}}: </td>
                <td><Input v-model="student.school" :placeholder="$t('AddContact.PlaceholderSchool')"></Input></td>
                <td></td>
              </tr>
            </table>
          </div>
          ...
          <div v-if="isStudent">
            ...
            <table class="contact-detail">
              <tr>
                ...
                <td>
                  <Input v-model="parent.firstName" :placeholder="$t('AddContact.PlaceholderFirstName')" style="width: 32%"></Input>
                  <Input v-model="parent.middleName" :placeholder="$t('AddContact.PlaceholderMiddleName')" style="width: 32%"></Input>
                  <Input v-show="!isLanguageCN" v-model="parent.lastName" :placeholder="$t('AddContact.PlaceholderLastName')" style="width: 32%"></Input>
                </td>
                <td></td>
              </tr>
              <tr>
                <td>{{$t('Common.Phone')}}: </td>
                <td><Input v-model="parent.phone" :placeholder="$t('AddContact.PlaceholderPhoneNumber')"></Input></td>
                <td></td>
              </tr>
              <tr>
                <td>{{$t('Common.Email')}}: </td>
                <td><Input v-model="parent.email" :placeholder="$t('AddContact.PlaceholderEmailAddress')"></Input></td>
                <td></td>
              </tr>
              <tr>
