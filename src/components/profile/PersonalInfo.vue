  ...
  <div id="user-profile-personal">
    <div class="personal-header">
      ...
      <div class="personal-desc">
        <!-- <Input v-model="user.nickname" :placeholder="$t('PersonalInfo.Nickname')" style="margin: 0.5em 0;"></Input> -->
    ...
    <div>
      <table class="personal-detail">
        <tr>
          ...
          <td><Input v-model="user.userName" disabled style="width: 50%"></Input><!--<Button type="text" style="color: darkblue;" @click="handleChangeUserName">Change</Button>--></td>
          <td></td>
        </tr>
        <tr>
